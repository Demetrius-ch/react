...
Lorsqu'on click sur le bouton, on constate que notre page se charge. **correction**
`event.preventDefault()`  
Enfin pour aller plus loin consulter la documentation de [tailwindcss](https://tailwindcss.com/) pour comprendre ce framework plus davantage. Ainsi que [react](https://react.dev/)  
